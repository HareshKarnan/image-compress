I want to build a website that takes as input an image and compresses it by half. the website runs a simple image compression algorithm and runs fully on the client side, so it is fast and secure. 
